  ...
  return (
    <div className="fixed inset-0 z-[300] bg-ops-bg flex items-center justify-center">
      <div className={`panel w-[380px] p-6 text-center ${shake ? "animate-pulse" : ""}`}>
        ...
        <div className="text-ops-dim text-[11px] tracking-widest mt-1 mb-6">ACCESS LOCKED — ENTER CODE TO CONTINUE</div>
        ...
        <div className="text-[10px] text-ops-amber border-t border-ops-border pt-3 leading-relaxed">
          PROTOTYPE LOCK ONLY — NOT REAL ACCESS CONTROL
          <br />
          Demo code: <span className="text-ops-text font-semibold">0000</span>
        </div>
      </div>
    </div>
  );
